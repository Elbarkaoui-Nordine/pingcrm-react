...
Route::get('forgot-password')->name('password.request')->uses('Auth\ForgotPasswordController@showForgotPasswordForm');
Route::post('forgot-password')->name('password.attempt')->uses('Auth\ForgotPasswordController@SendResetPasswordLink');
